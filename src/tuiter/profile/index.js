...
function ProfileComponent () {
    ...
    return(
        <div className="mt-2">
            ...
            <div className="row">
                <div className="col">
            <img src={userData.profilePicture} className="mx-4 wd-rounded-photo" alt="Profile Image" width="120px" height="120px"></img>
        </div>
                <div className="col">
            ...
            <div className="row">
                <div className="col mx-4 wd-move-up-40">
                    ...
                    <p className="wd-text-gray-profile">{userData.handle}</p>
                    <p className="wd-text-black">{userData.bio}</p>
                    <p className="wd-text-gray-profile">{userData.website}</p>

                </div>
            </div>


            <div className="row wd-text-gray-profile wd-move-up-40 mx-3">
            ...
            <div className="row mx-3 wd-move-up-30 wd-text-gray-profile">
